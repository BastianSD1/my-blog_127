...
var timercheck {
    if {
       miliseconds 1000= +1=<p id="timer"> 1</p>
...
var drawn_sketch {
    if {
    cursor=move =<p id="precicion"> +1</p>
...
var answer holder {
    if {
    cursor=move = cursor moving
      
    }
    else {
        cursor≠move = cursor not moving
